<%-- 
    Document   : register
    Created on : Feb 16, 2021, 3:00:16 PM
    Author     : tienx
--%>
                ...
                <div class="container">
                    <div class="col-md-4 ml-auto mr-auto">
                        ...
                        <div class="card card-login card-plain">
                            <form class="form" method="POST" action="RegisterController">
                                
                                <div class="card-body">
                                    <div class="input-group no-border input-lg">
                                        
                                        <input type="email" class="form-control" placeholder="Email" required="true"
                                               name="txtEmail" maxlength="30" value="${requestScope.EMAIL}">
                                    </div>
                                    <div class="input-group no-border input-lg">
                                        
                                        <input type="text" class="form-control" placeholder="Your name" required="true"
                                               name="txtUsername" maxlength="50" value="${requestScope.USERNAME}">
                                    </div>
                                    <div class="input-group no-border input-lg">
                                    ...
                                    <div class="input-group no-border input-lg">
                                        ...
                                        <input type="password" placeholder="Confirm password" class="form-control" required="true"
                                               name="txtConfirm" maxlength="20"/>
                                    </div>
                                ...
                                <div class="card-footer text-center">
                                    <button type="submit" class="btn btn-info btn-round btn-lg btn-block" 
                                            value="Login" name="action" >Register</button>
