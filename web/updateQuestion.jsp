<%-- 
    ...
    Created on : Feb 17, 2021, 5:55:12 PM
    Author     : tienx
--%>
                ...
                <form  action="UpdateQuestionController" method="POST" >
                    ...
                    <div class="form-group mb-2" style="margin: 5px">
                        ...
                        <input class="form-control" type="text" name="questionID" placeholder="Question ID" value="${requestScope.QUESTIONID}" 
                               maxlength="30" readonly="true" required="true"/>
                    </div>                    
                    ...
                    <div class="form-group mb-2" style="margin: 5px">
                        ...
                        <input class="form-control" type="datetime-local" name="createDate" value="${requestScope.CREATEDATE}" placeholder=""
                                   required="true" />
                    </div>            
                    ...
                    <div class="form-group mb-2" style="margin: 5px">                       
                        <button class="btn btn-info btn-round" type="submit" >Update</button>
                    </div>
